...
const Navbar = () =>{
          ...
          return (
                    <>
                              <nav className="w-full flex items-center py-4 top-0 z-20 bg-white ">
                                        <div className="w-full flex justify-between items-center max-w-[80%] mx-auto bg-white">
                                                  <Link to='/'><h2 className="bg-white text-[25px] font-medium">Nature Club</h2></Link>
